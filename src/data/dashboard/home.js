...
export const indexs = [{
  ...
  logo: 'https://www.lookintobitcoin.com/static/img/logo/logo-stacked.png',
}]
...
export const tools = [{
  ...
  logo: 'https://pbs.twimg.com/profile_images/1262741929114009600/CHoIwSUt_400x400.jpg',
},{
  name: '比特币十年走势',
...
export const browsers = [{
  ...
  logo: 'https://eospark.com/favicon.ico',
},{
  name: 'eosflare.io',
  url: 'https://eosflare.io/',
  logo: 'https://eosflare.io/static/img/icons/eosflare-32.png'
},{
  name: 'eosq',
  url: 'https://eosq.app/',
  logo: 'https://eosq.app/favicon.png',
},{
  name: 'EOSX',
  url: 'https://www.eosx.io/',
  logo: 'http://www.etwallet.io/images/developer_eosx.png',
}]
