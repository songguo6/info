...
export const fisco = [{
  ...
  logo: 'https://www.fisco.com.cn/images/fisco.ico',
},{
  name: '深入浅出FISCO BCOS',
  url: 'https://fisco-bcos-documentation.readthedocs.io/zh_CN/latest/docs/articles/index.html',
  logo: 'https://media.ethicalads.io/media/images/2020/01/readthedocs-logo-fs8_k6Ps9wN.png',
},{
  name: '区块链实用型技能树',
  url: 'https://fisco-bcos-documentation.readthedocs.io/zh_CN/latest/docs/articles/2_required/practical_skill_tree.html',
  logo: 'https://media.ethicalads.io/media/images/2020/01/readthedocs-logo-fs8_k6Ps9wN.png',
},{
  name: '智能合约开发教程',
...
export const zxin = [{
  ...
  logo: 'https://www.zxinchain.com/favicon.ico',
}]